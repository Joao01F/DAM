...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // This code lab uses View Binding
        ...
        db = Firebase.database("https://friendlychat-46570-default-rtdb.europe-west1.firebasedatabase.app")
    ...
    /**
     * If the user is not signed in, launch the Sign In activity.
     */
    ...
    /**
     * Uploads the image to Cloud Storage and then adds the download URL to the message.
     */
    ...
    private fun sendMessage(
        ...
        // Log and send the message to Firebase
